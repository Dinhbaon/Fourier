...
const CalcContoursDrawX=({fourier, translateX, translateY}) =>{
...
<div className="circle"style={{transform :`translate(${translateX.x}px, ${translateX.y}px)`,
                                width: `${2*fourier.x.frequency.amplitude[1]}px`, 
                                height:`${2*fourier.x.frequency.amplitude[1]}px` }} >    
                                <CalcContoursDrawX   fourier={{x:{frequency:{amplitude:fourier.x.frequency.amplitude.slice(1),
